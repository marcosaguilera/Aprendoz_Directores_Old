    ...
    implements Serializable
{
    ...
    public AdministracionVistaAsignaturasId() {
    }

    public AdministracionVistaAsignaturasId(Integer idAsignatura, String asignatura, Integer syIdSy, String grado, Integer idGrado, String subject) {
