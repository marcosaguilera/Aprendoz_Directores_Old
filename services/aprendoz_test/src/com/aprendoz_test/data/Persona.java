...
public class Persona {
    ...
    private Set<com.aprendoz_test.data.Logeventosaprendoz> logeventosaprendozs = new HashSet<com.aprendoz_test.data.Logeventosaprendoz>();
    ...
    private Set<com.aprendoz_test.data.LogDocentes> logDocenteses = new HashSet<com.aprendoz_test.data.LogDocentes>();
    ...
    public Set<com.aprendoz_test.data.AccStudentCard> getAccStudentCards() {
        return accStudentCards;
    }

    public void setAccStudentCards(Set<com.aprendoz_test.data.AccStudentCard> accStudentCards) {
        this.accStudentCards = accStudentCards;
    }
    ...
    public Set<com.aprendoz_test.data.Logeventosaprendoz> getLogeventosaprendozs() {
        return logeventosaprendozs;
    }

    public void setLogeventosaprendozs(Set<com.aprendoz_test.data.Logeventosaprendoz> logeventosaprendozs) {
        this.logeventosaprendozs = logeventosaprendozs;
    }
    ...
    public Set<com.aprendoz_test.data.ActualizacionDatosPersona> getActualizacionDatosPersonas() {
        return actualizacionDatosPersonas;
    }

    public void setActualizacionDatosPersonas(Set<com.aprendoz_test.data.ActualizacionDatosPersona> actualizacionDatosPersonas) {
        this.actualizacionDatosPersonas = actualizacionDatosPersonas;
    }

    public Set<com.aprendoz_test.data.FichaMedica> getFichaMedicas() {
        return fichaMedicas;
    }

    public void setFichaMedicas(Set<com.aprendoz_test.data.FichaMedica> fichaMedicas) {
        this.fichaMedicas = fichaMedicas;
    }
    ...
    public Set<com.aprendoz_test.data.LogDocentes> getLogDocenteses() {
        return logDocenteses;
    }

    public void setLogDocenteses(Set<com.aprendoz_test.data.LogDocentes> logDocenteses) {
        this.logDocenteses = logDocenteses;
    }

    public Set<com.aprendoz_test.data.PersonaCarne> getPersonaCarnes() {
        return personaCarnes;
    }

    public void setPersonaCarnes(Set<com.aprendoz_test.data.PersonaCarne> personaCarnes) {
        this.personaCarnes = personaCarnes;
    }
    ...
    public Set<com.aprendoz_test.data.PerfilPersonaImg> getPerfilPersonaImgs() {
        return perfilPersonaImgs;
    }

    public void setPerfilPersonaImgs(Set<com.aprendoz_test.data.PerfilPersonaImg> perfilPersonaImgs) {
        this.perfilPersonaImgs = perfilPersonaImgs;
    }
