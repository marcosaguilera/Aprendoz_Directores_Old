...
public class InscCoordinadorSubarea {
    ...
    public InscCoordinadorSubarea() {
    }

    public InscCoordinadorSubarea(Integer idCoordinadorSubarea, Integer personaIdPersona, Integer syIdSy, Integer subareaIdSubarea, Integer activo, Date fechaCreacion, Date fechaActualizacion) {
