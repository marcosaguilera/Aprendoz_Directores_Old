    ...
    implements Serializable
{
    ...
    public VistaDashboardNoCalificadosId() {
    }

    public VistaDashboardNoCalificadosId(Integer idAsignatura, Long asignaturasNoCalificadas, Long totalEstudiantes, BigDecimal totalPorcentaje, BigDecimal califPorcentaje, Long aprProgreso, Long sy) {
