...
/**
 *  aprendoz_test.InscAlumAsigCopy2
 *  05/19/2014 15:25:28
 * 
 */
public class InscAlumAsigCopy2 {
    ...
    public InscAlumAsigCopy2() {
    }

    public InscAlumAsigCopy2(Integer idInscAlumAsig, BigDecimal calificacion, BigDecimal porcentaje, Integer esperados, Integer logrados, String califChar) {
    ...
    public InscAlumAsigCopy2(Integer idInscAlumAsig, Asignatura asignatura, Persona persona, Periodo periodo, BigDecimal calificacion, BigDecimal porcentaje, Integer esperados, Integer logrados, String califChar) {
        this.idInscAlumAsig = idInscAlumAsig;
