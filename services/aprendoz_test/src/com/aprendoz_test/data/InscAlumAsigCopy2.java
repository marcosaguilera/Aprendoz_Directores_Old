...
public class InscAlumAsigCopy2 {
    ...
    public InscAlumAsigCopy2(Integer idInscAlumAsig, BigDecimal calificacion, BigDecimal porcentaje, Integer esperados, Integer logrados, String califChar, Asignatura asignatura, Persona persona, Periodo periodo) {
        this.idInscAlumAsig = idInscAlumAsig;
        this.calificacion = calificacion;
        this.porcentaje = porcentaje;
        this.esperados = esperados;
