dojo.declare("Reportes", wm.Page, {
  ...
  generar_buttClick: function(inSender, inEvent) {    
    ...
    if(codigoRep=="REC010"){
      ...
      var id= getter.data.idpersona;
      var clave= getter.data.clave;
      var pnumasi= this.num_asig_bajo.getDataValue();
      var pcurso= this.desde_curso_box.getDataValue();
      ...
      var idperiodo= this.periodo_box.getDataValue();
      var ppuntmin= this.puntaje.getDataValue();
      var ppuntmax= this.puntaje_max.getDataValue();  
      var formatType= this.formato_box.getDisplayValue();
      $.fileDownload("http://aprendoz.rochester.edu.co/wsreport/runreport?callback=?", {
        failMessageHtml: "Hubo un problema generando tu reporte, por favor intenta de nuevo.",
        httpMethod: "POST",
    ...
    if(codigoRep=="REC012"){
      ...
      var id= getter.data.idpersona;
      var clave= getter.data.clave;
      var pgrado1= this.grado_box.getDataValue();
      var pgrado2= this.grado_box2.getDataValue();
      var parea= this.area_box.getDataValue();
      var psy= this.sy_box.getDataValue();
      var formatType= this.formato_box.getDisplayValue();
      $.fileDownload("http://aprendoz.rochester.edu.co/wsreport/runreport?callback=?", {
        failMessageHtml: "Hubo un problema generando tu reporte, por favor intenta de nuevo.",
        ...
        data:{ idp: id, 
               ...
               format: formatType,
               params: { sy: psy, grado1: pgrado1, grado2: pgrado2, area: parea }
         }
       });
       inEvent.preventDefault();
    }   
    ...
    if(codigoRep=="REC028"){
      ...
      $.fileDownload("http://aprendoz.rochester.edu.co/wsreport/runreport?callback=?", {
        ...
        data:{ idp: id, 
               ...
               format: formatType,
               params: { idpersona: pidp, fecha: fullDate }
         }
       });
       inEvent.preventDefault();
    }
