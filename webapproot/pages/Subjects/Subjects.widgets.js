Subjects.widgets = {
	...
	layoutBox1: ["wm.Layout", {"height":"100%","width":"100%","horizontalAlign":"left","verticalAlign":"top","padding":"20"}, {}, {
		top_header: ["wm.Panel", {"height":"46px","width":"100%","horizontalAlign":"left","verticalAlign":"bottom","layoutKind":"left-to-right"}, {}, {
			asignatura_button: ["wm.Button", {"height":"40px","width":"110px","caption":"Asignaturas","margin":"4,4,0,4","borderColor":"#C1272D","iconUrl":"resources/images/buttons/subjects.png","iconWidth":"20px","iconHeight":"20px","iconMargin":"0 5px 0 0","roles":["10"]}, {"onclick":"asignatura_buttonClick"}],
			docentes_button: ["wm.Button", {"height":"40px","width":"110px","caption":"Docentes","margin":"4,4,0,4","borderColor":"#C1272D","iconUrl":"resources/images/news_icons/icon_2002.png","iconWidth":"20px","iconHeight":"20px","iconMargin":"0 5px 0 0","roles":["10"]}, {"onclick":"docentes_buttonClick"}],
			...
			areas_button: ["wm.Button", {"height":"40px","width":"96px","caption":"Areas","margin":"4,4,0,4","borderColor":"#C1272D","iconUrl":"resources/images/buttons/area2.png","iconWidth":"20px","iconHeight":"20px","iconMargin":"0 5px 0 0","roles":["10"]}, {"onclick":"areas_buttonClick"}],
			ejes_button: ["wm.Button", {"height":"40px","width":"96px","caption":"Ejes","margin":"4,4,0,4","borderColor":"#C1272D","iconUrl":"resources/images/buttons/eje2.png","iconWidth":"20px","iconHeight":"20px","iconMargin":"0 5px 0 0","roles":["10"]}, {"onclick":"ejes_buttonClick"}]
		}],
		subjects: ["wm.Panel", {"height":"100%","width":"100%","horizontalAlign":"left","verticalAlign":"top","layoutKind":"left-to-right","lock":true,"showing":false}, {}, {
			...
			main_form: ["wm.Panel", {"height":"100%","width":"75%","horizontalAlign":"center","verticalAlign":"top","padding":"0,10,10,10","autoScroll":true}, {}, {
				subject_panel: ["wm.Panel", {"_classes":{"domNode":["wm_BackgroundColor_VeryLightGray","wm_Border_TopStyleCurved8px"]},"height":"44px","width":"100%","horizontalAlign":"right","verticalAlign":"top","layoutKind":"left-to-right"}, {}, {
					subject_newRecord: ["wm.Button", {"height":"100%","width":"96px","caption":"Nuevo","disabled":true,"borderColor":"#0044cc"}, {"onclick":"subject_newRecordClick"}],
					subject_updateRecord: ["wm.Button", {"height":"100%","width":"96px","caption":"Actualizar","disabled":true,"borderColor":"#0044cc"}, {"onclick":"subject_updateRecordClick"}],
					...
					subject_deleteRecord: ["wm.Button", {"height":"100%","width":"96px","caption":"Borrar","disabled":true,"borderColor":"#bd362f"}, {"onclick":"subject_deleteRecordClick"}]
				}],
		...
		docentes: ["wm.Panel", {"_classes":{"domNode":["wm_BackgroundColor_VeryLightGray"]},"height":"100%","width":"100%","horizontalAlign":"left","verticalAlign":"top","padding":"10","lock":true,"showing":false}, {}, {
			...
			docentes_details_panel: ["wm.Panel", {"height":"100%","width":"100%","horizontalAlign":"left","verticalAlign":"top"}, {}, {
				docentes_action_button: ["wm.Panel", {"height":"35px","width":"100%","horizontalAlign":"center","verticalAlign":"top","padding":"2","layoutKind":"left-to-right"}, {}, {
					...
					docentesRetirar: ["wm.Button", {"_classes":{"domNode":["wm_BackgroundColor_White"]},"height":"100%","width":"100px","caption":"[-] Retirar","disabled":true,"margin":"0","borderColor":"#c6353a "}, {"onclick":"docentesRetirarClick"}]
				}],
		...
		learnings: ["wm.Panel", {"height":"100%","width":"100%","horizontalAlign":"left","verticalAlign":"top","layoutKind":"left-to-right","lock":true}, {}, {
			panel6: ["wm.Panel", {"height":"100%","width":"252px","horizontalAlign":"left","verticalAlign":"top"}, {}, {
				aprendizajes_sy: ["wm.SelectEditor", {"width":"100%","caption":"Año escolar"}, {"onchange":"aprendizajes_syChange"}, {
			...
			aprendizajes_aprendizajes: ["wm.DojoGrid", {"height":"750px","border":"0","structure":"[[{\"field\":\"idAprendizaje\",\"name\":\" \",\"width\":\"50px\",\"displayType\":\"Number\"},{\"field\":\"fechaEsperada\",\"name\":\"Fecha esperada\",\"width\":\"60px\",\"displayType\":\"Date\",\"typeValue\":\"\",\"editable\":false,\"type\":\"\",\"expression\":\"\"},{\"field\":\"aprendizaje\",\"name\":\"Aprendizaje\",\"width\":\"auto\",\"displayType\":\"Text\"},{\"field\":\"peso\",\"name\":\"Peso\",\"width\":\"30px\",\"displayType\":\"Number\"}]]","width":"386px"}, {"onClick":"aprendizajes_aprendizajesClick","onSelectionChange":"aprendizajes_aprendizajesSelectionChange"}, {
				binding: ["wm.Binding", {}, {}, {
			...
			panel7: ["wm.Panel", {"_classes":{"domNode":["wm_Border_TopStyleCurved4px","wm_Border_BottomStyleCurved4px","wm_BackgroundColor_VeryLightGray"]},"height":"100%","width":"100%","horizontalAlign":"left","verticalAlign":"top","padding":"10"}, {}, {
				...
				editPanel3: ["wm.EditPanel", {"liveForm":"learningsLiveForm1","savePanel":"savePanel3","operationPanel":"operationPanel3","lock":false}, {}, {
					savePanel3: ["wm.Panel", {"height":"100%","width":"100%","horizontalAlign":"right","verticalAlign":"top","layoutKind":"left-to-right","showing":false}, {}, {
						...
						saveButton3: ["wm.Button", {"_classes":{"domNode":["wm_FontColor_White","wm_BackgroundColor_White"]},"height":"100%","width":"100px","caption":"Guardar","disabled":undefined,"border":"0"}, {"onclick":"saveButton3Click"}, {
							binding: ["wm.Binding", {}, {}, {
					...
					operationPanel3: ["wm.Panel", {"height":"100%","width":"100%","horizontalAlign":"right","verticalAlign":"top","layoutKind":"left-to-right"}, {}, {
						newButton3: ["wm.Button", {"_classes":{"domNode":["wm_BackgroundColor_White","wm_FontColor_White"]},"height":"100%","width":"100px","caption":"Nuevo","disabled":true,"border":"0"}, {"onclick":"newButton3Click"}],
						updateButton3: ["wm.Button", {"_classes":{"domNode":["wm_BackgroundColor_White","wm_FontColor_White"]},"height":"100%","width":"100px","caption":"Actualizar","disabled":true,"border":"0"}, {"onclick":"updateButton3Click"}, {
							binding: ["wm.Binding", {}, {}, {
